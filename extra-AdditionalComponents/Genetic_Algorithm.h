...
public:
	// Constructors:
	Genetic_Algorithm(int num_units, int numCircuits, double pCrossOver, double pMut,
		double tol, int max_iterations, bool timeGA, vector<double> flow,
		vector<double> fraction, vector<double> prices, int num_components);
	~Genetic_Algorithm();
	...
	//circuit info
	vector<double> flow_rate;
	vector<double> price_component;
	vector<double> fraction_component;
	int num_components;
